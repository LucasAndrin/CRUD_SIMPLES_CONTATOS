...
<template>
  <main class="main-pd" id="main-pd">
    ...
    <div class="sidebar pt-md-2 pt-1 pe-md-1 pe-2 pb-2 h-100 bg-white border-end sidebar-show" id="sidebar">
      <nav class="nav d-flex flex-column justify-content-between h-100 overflow-hidden">
        <div>
          ...
          <RouterLink to="/cities" class="d-flex align-items-center gap-3 nav-link text-indigo text-decoration-none ps-4 pt-2 pl-2">
        ...
        <a href="#" class="d-flex align-items-center gap-3 nav-link text-indigo text-decoration-none ps-4 pt-2 pl-2">
    ...
    <div class="container-fluid">
      <RouterView class="flex-fill overflow-auto"/>
    </div>
    <!--Container Main end-->
